...
const IMPORTS = [
  ...
  "import { FluentProvider, webLightTheme, Link, Text, Badge, Button, ToggleButton } from '@fluentui/react-components';",
  ...
  'const {',
  '  Lookup, QueryBuilder, CommandBar, EntityGrid, DateTimeField, OptionSetField,',
